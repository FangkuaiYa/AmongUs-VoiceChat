...
namespace VoiceChatPlugin
{
    ...
    public static class PingTrackerPatch
    {
        ...
        private static readonly AspectPosition.EdgeAlignments SpeakingAnchor
        ...
        static void Postfix(PingTracker __instance)
        {
            ...
            if (_speakingTracker?.text == null) return;
        ...
        private static void CreateSpeakingTracker(PingTracker template)
        {
            ...
            go.name          = "VC_SpeakingPingTracker";
            go.SetActive(true);
            _speakingTracker = go.GetComponent<PingTracker>();
            ...
            _speakingAspect = go.GetComponent<AspectPosition>() ?? go.AddComponent<AspectPosition>();
            _speakingAspect.Alignment        = SpeakingAnchor;
            _speakingAspect.DistanceFromEdge = SpeakingDistanceFromEdge;
            _speakingAspect.AdjustPosition();
        }

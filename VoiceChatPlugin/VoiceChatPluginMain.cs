...
public class VoiceChatPluginMain : BasePlugin
{
    ...
    private static readonly Dictionary<string, Assembly> _cacheTestByElinmeiFarewellTAIKImp11
...
#if ANDROID
            // 在 Harmony 打 patch 之前注册 IL2CPP 注入类，
            // 否则后续 AddComponent<VCAndroidAudioPuller>() 会崩溃。
            VoiceChat.VCAndroidAudioPuller.EnsureRegistered();
#endif
        }
        catch (Exception ex)
        {

...
namespace VoiceChatPlugin.NAudio.Wave.Compression
{
    /// <summary>
    ...
    class AcmInterop
    {
        ...
        public static extern MmResult acmFormatSuggest(
            IntPtr hAcmDriver,
            [In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "VoiceChatPlugin.NAudio.Wave.WaveFormatCustomMarshaler")] 
            WaveFormat sourceFormat,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "VoiceChatPlugin.NAudio.Wave.WaveFormatCustomMarshaler")] 
